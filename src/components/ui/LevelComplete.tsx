...
const LevelComplete: React.FC = () => {
  ...
  useEffect(() => {
    if (gameState.gameStatus === "levelComplete") {
      ...
      const totalCoins = gameState.collectibles.length;

      setStats({
        coinsCollected: collectedCoins,
        totalCoins: totalCoins,
        timeElapsed: 120, // Placeholder - you'd track this in your game state
        enemiesDefeated: 3, // Placeholder - you'd track this in your game state
      });
      ...
      const coinPercentage =
        stats.totalCoins > 0 ? stats.coinsCollected / stats.totalCoins : 1;
      if (coinPercentage >= 0.8) starCount++;

      // Star 3: Complete within time limit (varies by level)
      const timeLimit = 180; // 3 minutes default
  ...
  return (
    <div
      className="level-complete-container"
      style={{
        position: "absolute",
        top: 0,
        left: 0,
    ...
    >
      <div
        className="level-complete-content"
        style={{
      ...
      >
        <h1
          style={{
            ...
            transform:
              animationPhase >= 1 ? "translateY(0)" : "translateY(-20px)",
        ...
        <div
          ...
          style={{
            ...
            transform:
              animationPhase >= 3 ? "translateX(0)" : "translateX(-20px)",
            transition: "opacity 0.5s, transform 0.5s",
          }}
        >
          <div
        ...
        <div
          ...
          style={{
            ...
            transform:
              animationPhase >= 4 ? "translateY(0)" : "translateY(20px)",
            transition: "opacity 0.5s, transform 0.5s",
          }}
        >
          <button
