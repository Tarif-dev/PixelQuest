  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="An award-winning retro-style platform game with stunning pixel art and modern web techniques" />
      ...
      <main className="h-screen w-screen bg-dark flex flex-col items-center justify-center p-4">
        ...
        >
          ...
          >
            Embark on a pixel-perfect adventure filled with challenging platforms,
            hidden collectibles, and retro charm!
          </motion.p>
        ...
        >
          Use arrow keys to move, space to jump. Mobile controls available in-game.
        </motion.div>
      </main>
    </>
  );
